...
public class StateLinkParticipantsToTeam : IState
{
    ...
    public void Enter(IStateMachine context)
    {
        ...
        ChatApi.AddLocalMessage("Register Team ->'#set team <teamtag>, <teamtag>'");
    ...
    private void OnSetTeam(string arg)
    {
        ...
        Team teamA = _teams.FirstOrDefault(team => team.Tag.Equals(teamTags[0].Trim(), StringComparison.OrdinalIgnoreCase));
        Team teamB = _teams.FirstOrDefault(team => team.Tag.Equals(teamTags[1].Trim(), StringComparison.OrdinalIgnoreCase));
